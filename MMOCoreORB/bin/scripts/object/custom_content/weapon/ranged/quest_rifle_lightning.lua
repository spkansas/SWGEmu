...
object_weapon_ranged_rifle_quest_rifle_lightning = object_weapon_ranged_rifle_shared_quest_rifle_lightning:new {
...
ObjectTemplates:addTemplate(object_weapon_ranged_rifle_quest_rifle_lightning, "object/weapon/ranged/rifle/quest_rifle_lightning.iff")
