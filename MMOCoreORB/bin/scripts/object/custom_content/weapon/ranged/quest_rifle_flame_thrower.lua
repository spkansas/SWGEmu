...
object_weapon_ranged_rifle_quest_rifle_flame_thrower = object_weapon_ranged_rifle_shared_quest_rifle_flame_thrower:new {
...
ObjectTemplates:addTemplate(object_weapon_ranged_rifle_quest_rifle_flame_thrower, "object/weapon/ranged/rifle/quest_rifle_flame_thrower.iff")
