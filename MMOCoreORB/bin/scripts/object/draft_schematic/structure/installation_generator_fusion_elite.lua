...
object_draft_schematic_structure_installation_generator_fusion_elite = object_draft_schematic_structure_shared_installation_generator_fusion_elite:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Deed for: ELITE Fusion Power Generator",
	...
	resourceQuantities = {600, 1400, 2, 500, 500, 10, 600, 6, 8, 4},
	contribution = {100, 100, 100, 100, 100, 100, 100, 100, 100, 100},

	targetTemplate = "object/tangible/deed/generator_deed/generator_fusion_deed_elite.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_structure_installation_generator_fusion_elite, "object/draft_schematic/structure/installation_generator_fusion_elite.iff")
